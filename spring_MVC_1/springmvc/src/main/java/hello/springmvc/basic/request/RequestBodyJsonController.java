...
public class RequestBodyJsonController {
    ...
    public String requsetBodyJsonV3(@RequestBody HelloData messageBody) {
        log.info("messageBody={}", messageBody);
        return "ok";
    }
    ...
    public String requsetBodyJsonV4(HttpEntity<HelloData> httpEntity) {
    ...
    public HelloData requsetBodyJsonV5(@RequestBody HelloData data) {
        log.info("messageBody={}", data);
        return data;
    }
}
